...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠉⠓⠒⠚⠉⠀⠉⠉⠉⠉⠉⠉⠉⠉⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
    ...
    # Get random banner or cycle through them
    import random
    print("\033[94m" + random.choice(ascii_art_collection) + "\033[0m")

def print_menu():
    blue = '\033[94m'
    reset = "\033[0m"
    
    # Print random ASCII art banner
    ...
    print(f"{blue}{vertext.center(terminal_width)}{reset}")
    print(f"{blue}{separator}{reset}")
    print(motd1.center(terminal_width))
    print(motd2.center(terminal_width))
    print(f"{blue}{separator}{reset}")
